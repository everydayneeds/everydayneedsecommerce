  ...
  >
    <div className="relative aspect-[4/3] overflow-hidden">
      ...
      <div className="absolute top-4 left-4">
        <span className="px-3 py-1 bg-white/90 backdrop-blur-sm text-[10px] font-bold uppercase tracking-wider text-emerald-600 rounded-full shadow-sm">
          {product.category}
        </span>
      </div>
      <button 
        ...
        className={`absolute top-4 right-4 p-2.5 rounded-2xl backdrop-blur-md transition-all ${
          isLiked ? 'bg-red-500 text-white' : 'bg-white/80 text-zinc-400 hover:text-red-500'
        }`}
      >
    ...
    <div className="p-8 flex flex-col flex-grow">
      ...
      <div className="flex items-center justify-between mt-auto">
        <div>
          <span className="text-[10px] text-zinc-400 block uppercase tracking-widest font-bold mb-1">Price</span>
        ...
        <div className="space-y-8">
          <div className="aspect-[4/3] rounded-[3rem] overflow-hidden shadow-2xl relative group">
            ...
            <button 
              ...
              className={`absolute top-6 right-6 p-4 rounded-3xl backdrop-blur-md transition-all shadow-xl ${
                isLiked ? 'bg-red-500 text-white' : 'bg-white/80 text-zinc-400 hover:text-red-500'
              }`}
            >
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
                        selectedPlan === plan.id ? 'border-emerald-600 bg-emerald-600' : 'border-zinc-300'
                      }`}>
    ...
    <div className="flex items-center gap-4 relative">
      ...
      {showDatePicker && (
        <div className="absolute top-full right-0 mt-2 p-4 bg-white rounded-2xl shadow-xl border border-zinc-100 z-[60] w-64">
          <h4 className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-3">Custom Range</h4>
          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-4">
              <button className="aspect-square bg-zinc-50 border-2 border-dashed border-zinc-200 rounded-2xl flex flex-col items-center justify-center text-zinc-400 hover:border-emerald-500 hover:text-emerald-600 transition-all">
                <Plus size={24} />
                <span className="text-[10px] font-bold mt-1 uppercase tracking-widest">Add Image</span>
              </button>
        ...
        <div className="space-y-6">
          ...
          {status === 'On Transit' && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-6 bg-emerald-50 rounded-2xl border border-emerald-100 animate-in fade-in slide-in-from-top-2">
              <div>
                <label className="block text-[10px] font-bold text-emerald-700 uppercase tracking-widest mb-1.5">Tracking Code</label>
                <input 
                  type="text" 
              ...
              <div>
                <label className="block text-[10px] font-bold text-emerald-700 uppercase tracking-widest mb-1.5">Courier Phone</label>
                <input 
                  type="text" 
              ...
              <div>
                <label className="block text-[10px] font-bold text-emerald-700 uppercase tracking-widest mb-1.5">Company Name</label>
                <input 
                  type="text" 
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 bg-zinc-50 rounded-2xl border border-zinc-100">
              ...
              <div className="flex items-center justify-between">
                <span className="px-3 py-1 bg-emerald-100 text-emerald-700 text-[10px] font-bold rounded-full uppercase tracking-wider">Active</span>
...
const DashboardLayout = ({ 
  ...
  return (
    <div className="flex h-screen bg-[#F4F7FE] overflow-hidden font-sans">
      {/* Sidebar */}
      <aside 
        className={`bg-white border-r border-zinc-200 flex flex-col h-full transition-all duration-300 ease-in-out ${
        ...
        <nav className="flex-grow py-6 overflow-y-auto no-scrollbar">
          {sidebarGroups.map((group, gIdx) => (
            <div key={group.title} className={gIdx !== 0 ? 'mt-6' : ''}>
              {!isSidebarCollapsed && (
                <p className="px-6 text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-3">
                  {group.title}
                </p>
              )}
              ...
              <div className="divide-y divide-zinc-100">
                {subscriptions.slice(0, 3).map((sub, i) => (
                  <div key={i} className="flex items-center justify-between p-4 hover:bg-zinc-50 transition-colors">
                    ...
                    <span className="text-[10px] font-bold text-zinc-400">2 days ago</span>
                  </div>
                ))}
                    ...
                    <div key={i} className="flex items-center justify-between p-4 bg-zinc-50 rounded-xl border border-zinc-200">
                      ...
                      <div className="flex items-center gap-2">
                        <button 
                          ...
                          className="px-3 py-1.5 bg-white border border-zinc-200 rounded-lg text-[10px] font-bold hover:bg-zinc-100 transition-all"
                        >
                          Manage
                        </button>
                        <span className="px-2 py-1 bg-emerald-100 text-[9px] font-bold uppercase tracking-wider text-emerald-700 rounded-lg">
                          {sub.status}
                        </span>
                      </div>
                    </div>
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-zinc-50 border-b border-zinc-100">
                    ...
                    <th className="px-6 py-3 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Items</th>
        ...
        return (
          <div className="max-w-2xl bg-white rounded-xl border border-zinc-200 shadow-sm overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                <label className="block text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-1.5">Delivery Address</label>
              ...
              {[
                ...
                <div key={i} className="p-4 flex gap-4 hover:bg-zinc-50 transition-colors cursor-pointer">
                  ...
                  <div className="flex-grow">
                    ...
                    <p className="text-[10px] font-bold text-zinc-400 mt-1 uppercase tracking-widest">{n.time}</p>
                  </div>
                </div>
              ))}
            </div>
              ...
              {[
                ...
                <div key={i} className="p-5 bg-white rounded-xl border border-zinc-200 shadow-sm">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="text-[10px] font-bold text-emerald-600">{stat.trend}</div>
                  </div>
                  <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-0.5">{stat.label}</p>
                  <p className="text-xl font-bold text-zinc-900">{stat.value}</p>
                </div>
              ...
              {[1,2,3,4].map(i => (
                <div key={i} className="p-3 border border-zinc-200 rounded-xl space-y-3 hover:shadow-md transition-all">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-zinc-500">8 orders this week</p>
                  </div>
                  <div className="flex items-center justify-between pt-1">
                    ...
                    <div className="flex gap-2">
                      <button 
                        ...
                        className="text-[10px] font-bold text-zinc-400 hover:text-emerald-600 transition-colors"
                      >
                        Edit
                      </button>
                      <button className="text-[10px] font-bold text-zinc-400 hover:text-red-600 transition-colors">Delete</button>
                    </div>
                  </div>
                </div>
              ))}
        ...
        return (
          <div className="max-w-2xl bg-white rounded-xl border border-zinc-200 shadow-sm overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                <label className="block text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-1.5">Store Name</label>
              ...
              <div>
                <label className="block text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-1.5">Store Description</label>
              ...
              <div className="pt-4 border-t border-zinc-100">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-1.5">Address</label>
              ...
              {[
                ...
                <div key={i} className="p-5 bg-white rounded-xl border border-zinc-200 shadow-sm">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className={`flex items-center gap-1 text-[10px] font-bold ${stat.trend.startsWith('+') ? 'text-emerald-600' : 'text-red-500'}`}>
            ...
            <div className="bg-white rounded-xl border border-zinc-200 shadow-sm overflow-hidden">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left">
                  <thead>
                    <tr className="bg-zinc-50 border-b border-zinc-100">
                      <th className="px-4 py-3 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Order ID</th>
                      <th className="px-4 py-3 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Customer</th>
                      <th className="px-4 py-3 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Product</th>
                      ...
                      <th className="px-4 py-3 text-[10px] font-bold text-zinc-400 uppercase tracking-widest w-20">Action</th>
                    </tr>
                  </thead>
                  <tbody className="divide-y divide-zinc-100">
                    {[
                  ...
                  <div key={i} className="flex items-center justify-between p-4 bg-zinc-50 rounded-xl border border-zinc-100">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-zinc-500">Monthly Plan • Next delivery: Mar 1{i}</p>
                      </div>
                    </div>
                    <button 
                      onClick={() => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              {[1,2,3,4,5,6,7,8].map(i => (
                <div key={i} className="bg-white p-3 rounded-xl border border-zinc-200 shadow-sm hover:shadow-md transition-all">
                  ...
                  <p className="text-[10px] text-zinc-500 mb-2">Category • ₦15,000</p>
                  <div className="flex gap-2">
                    <button 
                      onClick={() => {
                      ...
                      className="flex-1 py-1.5 bg-zinc-100 rounded-lg text-[10px] font-bold hover:bg-zinc-200 transition-all"
                    >
                      Edit
                    </button>
                    <button className="flex-1 py-1.5 bg-red-50 text-red-600 rounded-lg text-[10px] font-bold hover:bg-red-100 transition-all">Delete</button>
                  </div>
                </div>
              ))}
            </div>
        ...
        return (
          <div className="bg-white rounded-xl border border-zinc-200 shadow-sm overflow-hidden">
            <div className="p-5 border-b border-zinc-100 flex items-center justify-between">
              ...
              <span className="px-2 py-1 bg-red-100 text-red-600 text-[10px] font-bold rounded-lg">5 Low Stock Items</span>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-zinc-50 border-b border-zinc-100">
                    <th className="px-4 py-3 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Item</th>
                    <th className="px-4 py-3 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Stock Level</th>
                    <th className="px-4 py-3 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Status</th>
                    <th className="px-4 py-3 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Last Restocked</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-zinc-100">
                  {[
            ...
            {[1,2,3,4].map(i => (
              <div key={i} className="bg-white p-6 rounded-xl border border-zinc-200 shadow-sm flex items-center gap-6">
                ...
                <div className="flex-grow">
                  ...
                  <div className="flex gap-4">
                    <span className="text-[10px] font-bold text-emerald-600">4.9 Rating</span>
                    <span className="text-[10px] font-bold text-zinc-400">124 Deliveries</span>
                  </div>
                </div>
          ...
          <div className="bg-white rounded-xl border border-zinc-200 shadow-sm overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-zinc-50 border-b border-zinc-100">
                    <th className="px-4 py-3 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Transaction ID</th>
                    <th className="px-4 py-3 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Customer</th>
                    <th className="px-4 py-3 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Amount</th>
                    <th className="px-4 py-3 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Method</th>
                    <th className="px-4 py-3 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Status</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-zinc-100">
                  {[
                    ...
                    >
                      ...
                      <td className="px-4">
                        <span className={`px-2 py-1 rounded-lg text-[9px] font-bold uppercase tracking-wider ${
                          trx.status === 'Successful' ? 'bg-emerald-100 text-emerald-700' :
              ...
              {[1,2,3,4,5,6].map(i => (
                <div key={i} className="bg-white p-6 rounded-xl border border-zinc-200 shadow-sm">
                  ...
                  <div className="grid grid-cols-2 gap-4 py-4 border-y border-zinc-100 mb-4">
                    ...
                    <div>
                      <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Total Spent</p>
      ...
      case 'analytics':
        return (
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-xl border border-zinc-200 shadow-sm">
                <h4 className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-1">Conversion Rate</h4>
              ...
              <div className="bg-white p-6 rounded-xl border border-zinc-200 shadow-sm">
                <h4 className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-1">Average Order Value</h4>
              ...
              <div className="bg-white p-6 rounded-xl border border-zinc-200 shadow-sm">
                <h4 className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-1">Customer Retention</h4>
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-zinc-50 border-b border-zinc-100">
                    ...
                    <th className="px-4 py-3 text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Email</th>
                ...
                <tbody className="divide-y divide-zinc-100">
                  {[
                    ...
                    <tr key={i} className="h-12 hover:bg-zinc-50 transition-colors">
                      ...
                      <td className="px-4">
                        <span className={`px-2 py-1 rounded-lg text-[9px] font-bold uppercase tracking-wider ${
                          admin.status === 'Active' ? 'bg-emerald-100 text-emerald-700' : 'bg-zinc-100 text-zinc-500'
                        }`}>
                          {admin.status}
                        </span>
                      </td>
  ...
  return (
    ...
    >
          ...
          >
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-1">Method</p>
                  <p className="text-sm font-bold text-zinc-900">{selectedPayment.method}</p>
                </div>
              </div>
              <div className="p-4 bg-zinc-50 rounded-2xl border border-zinc-100">
                <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-2">Status</p>
                <span className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider ${
                  selectedPayment.status === 'Successful' ? 'bg-emerald-100 text-emerald-700' :
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <DashboardFilter onFilterChange={(f) => console.log('Filter changed', f)} />
      </div>
      {renderContent()}
    </DashboardLayout>
  );
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-4 text-sm font-medium text-zinc-600">
                ...
                <li><button className="hover:text-emerald-600">Investors</button></li>
                <li><button className="hover:text-emerald-600">Contact</button></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-4 text-sm font-medium text-zinc-600">
                ...
                <li><button className="hover:text-emerald-600">Delivery Policy</button></li>
              </ul>
            </div>
          </div>
